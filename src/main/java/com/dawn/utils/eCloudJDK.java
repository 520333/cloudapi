...
public class eCloudJDK {
    ...
    // public static final String TITLE_RENEW="账号恢复通知";
    public static final String SIZE="size";
    public static final String SIZE_COUNT="1";
    public String accessKey;
    public String secretKey;
    public String TITLE_RENEW;
    ...
    public String doSignature(String servletPath, String method, Map<String,Object> query) {
        try {
            ...
            query.put(TITLE,TITLE_RENEW);
            query.put(SIZE,SIZE_COUNT);
            // query.put(TITLE,TITLE_DOWN);
            // query.put(TYPE,TYPE);
